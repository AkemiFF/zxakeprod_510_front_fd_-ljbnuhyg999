...
export default function ListAdminAccommodation() {
  ...
  const [accommodation, setOperators] = useState<Accommodation[]>([]);
  ...
  useEffect(() => {
    fetch(`${Urlconfig.apiBaseUrl}/api/accounts/responsables/type/1/`)
  ...
  const filteredData = useMemo(() => {
    return accommodation.filter(operator => {
